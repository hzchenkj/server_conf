...
# -----------------------------------------------------------------------------
 ...
 JAVA_OPTS="-server -Xms1048m -Xmx1048m -XX:NewRatio=2  -XX:PermSize=512M -XX:MaxPermSize=1024M  -XX:+HeapDumpOnOutOfMemoryError 
 -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=16689 -Dcom.sun.management.jmxremote.authenticate=false 
 -Dcom.sun.management.jmxremote.ssl=false -Djava.awt.headless=true 
 -DmqEnable=0 -Deis.run.subsystem=eis_basedata -Deis.import.start=true -Deis.update.grade.name=true"
